...
/** Brand marks and section-emphasis icons are filled; the rest are 1.5px-stroke line icons (Lucide-style). */
const FILLED: Partial<Record<IconName, string>> = {
  ...
  widgets:
    'M13 13v8h8v-8h-8zM3 21h8v-8H3v8zM3 3v8h8V3H3zm13.66-1.31L11 7.34 16.66 13l4.66-4.66-4.66-4.66z',
  ...
  build:
    'M22.7 19l-9.1-9.1c.9-2.3.4-5-1.5-6.9-2-2-5-2.4-7.5-1.3L9 6 6 9 1.6 4.7C.4 7.1.9 10.1 2.9 12.1c1.9 1.9 4.6 2.4 6.9 1.5l9.1 9.1c.4.4 1 .4 1.4 0l2.3-2.3c.5-.4.5-1.1.1-1.4z',
}
